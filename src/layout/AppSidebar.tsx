...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: 'Services',
    subItems: [
      { name: 'AllService Categories', path: '/admin/service-categories/', pro: false },
      { name: 'All Services', path: '/admin/service/', pro: false },
    ],
  },
  {
    icon: Calendar,
  ...
  },
  {
    ...
    name: 'Payments',
    subItems: [
      { name: 'All Payments', path: '#', pro: false },
    ],
  },
  // {
    //   icon: Calendar,
...
const othersItems: NavItem[] = [
  {
    ...
    subItems: [
      { name: 'All Clients', path: '#', pro: false },
    ],
  },
  {
    icon: UserCheck,
    ...
    subItems: [
      { name: 'All Employee Assignments', path: '#', pro: false },
    ],
  },
  {
      icon: Calendar,
...
const paymentReportItems: NavItem[] = [
  {
    icon: DollarSign,
    name: 'Invoices',
    path: '#',
