...
import { updateService as updateServiceValidator } from "@/validators/user.validation";
...
export default function EditService() {
  ...
  // Fetch single blog
  const { data: serviceData, fetchApi: fetchService } = useApi({
    url: `/api/admin/service/${slug}`,
    method: "GET",
    type: "manual",
    requiresAuth: true,
  });
  ...
  useEffect(() => {
    ...
    const updateServiceForm = async (e: React.FormEvent) => {
    e.preventDefault();
    setErrorMsg("");
    ...
    try {
      ...
      formData.append("servicesCategoryId", serviceCategoryId);
    ...
    <div className="p-4 mx-auto md:p-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-white/[0.03]">
        ...
        <div className="p-4 sm:p-6">
          <form onSubmit={updateServiceForm} className="space-y-5">
            {/* Service Category */}
            <div>
              <label className="block mb-1 text-sm font-medium">Service Category <span className="text-red-500">*</span></label>
              <select
            ...
            {/* Title */}
            <div>
              <label className="block mb-1 text-sm font-medium">Service Title <span className="text-red-500">*</span></label>
              <input
                type="text"
