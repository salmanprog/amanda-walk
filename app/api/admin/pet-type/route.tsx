...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Error uploading pet type image:", error);
    return NextResponse.json(
...
export async function GET(req: Request) {
  ...
  const controller = new AdminPetTypeController(req, { id: Number(user.id) });
