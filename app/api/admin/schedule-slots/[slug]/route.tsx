...
import AdminScheduleSlotsController from "@/controllers/AdminScheduleSlotsController";
import type { ExtendedScheduleSlot } from "@/resources/AdminScheduleSlotsResource";
...
export async function GET(
  ...
  try {
    const controller = new AdminScheduleSlotsController(_req);
...
export async function PATCH(
  ...
  let data: Partial<ExtendedScheduleSlot> = {};
  ...
  try {
    ...
    const controller = new AdminScheduleSlotsController(requestWithUser(request, user), data);
...
export async function DELETE(
  ...
  const params = await context.params;
  try {
    const controller = new AdminScheduleSlotsController(requestWithUser(req, user));
