...
import AdminEmployeeController, { ExtendedEmployee } from "@/controllers/AdminEmployeeController";
...
export async function GET(
  ...
  try {
    const controller = new AdminEmployeeController(_req);
...
export async function PATCH(
  ...
  let data: Partial<ExtendedEmployee> = {};
  ...
  try {
    ...
    const controller = new AdminEmployeeController(request, data);
...
export async function DELETE(
  ...
  try {
    const slug = params.slug;
    const controller = new AdminEmployeeController();
